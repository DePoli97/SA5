...
class StreamingDecoder(object):
    ...
    asn1Spec: :py:class:`~pyasn1.type.base.PyAsn1Item`
        A pyasn1 type object to act as a templates guiding the decoder.
...
class Decoder(object):
    ...
    def __call__(cls, substrate, asn1Spec=None, **options):
        ...
        asn1Spec: :py:class:`~pyasn1.type.base.PyAsn1Item`
            ...
            derivative) to act as a templates guiding the decoder.
...
#:     A pyasn1 type object to act as a templates guiding the decoder. Depending on the ASN.1 structure
