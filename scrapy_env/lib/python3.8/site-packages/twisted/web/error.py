...
class RenderError(Exception):
    """
    Base exception class for all errors which can occur during templates
    rendering.
    """
...
class MissingTemplateLoader(RenderError):
    ...
    a templates loader, i.e. a C{loader} attribute.
...
class FlattenerError(Exception):
    ...
    def __repr__(self) -> str:
        """
        Present a string representation which includes a templates traceback, so
        we can tell where this error occurred in the templates, as well as in
        Python.
        """
