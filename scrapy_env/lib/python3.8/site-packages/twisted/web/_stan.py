...
class slot:
    """
    Marker for markup insertion in a templates.
    """
    ...
    """
    The L{Tag} objects included in this L{slot}'s templates.
    """
...
class Tag:
    ...
    A L{Tag} can be constructed using the special L{twisted.web.templates.tags}
    ...
    L{twisted.web.templates.Element} doing the rendering,
    via L{twisted.web.templates.Element.lookupRenderMethod},
...
class CDATA:
    """
    A C{<![CDATA[]]>} block from a templates.  Given a separate representation in
...
class Comment:
    """
    A C{<!-- -->} comment from a templates.  Given a separate representation in
    the DOM so that they may be round-tripped through rendering without losing
    information.
    """
