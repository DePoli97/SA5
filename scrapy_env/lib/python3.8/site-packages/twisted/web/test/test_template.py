...
"""
Tests for L{twisted.web.templates}
"""
...
class XMLFileReprTests(TestCase):
    """
    Tests for L{twisted.web.templates.XMLFile}'s C{__repr__}.
    """
...
class XMLLoaderTestsMixin:
    ...
    """
    Simple templates to use to exercise the loaders.
    """
...
class XMLStringLoaderTests(TestCase, XMLLoaderTestsMixin):
    """
    Tests for L{twisted.web.templates.XMLString}
    """
...
class XMLFileWithFilePathTests(TestCase, XMLLoaderTestsMixin):
    """
    Tests for L{twisted.web.templates.XMLFile}'s L{FilePath} support.
    """
...
class XMLFileWithFileTests(TestCase, XMLLoaderTestsMixin):
    """
    Tests for L{twisted.web.templates.XMLFile}'s deprecated file object support.
    """
...
class XMLFileWithFilenameTests(TestCase, XMLLoaderTestsMixin):
    """
    Tests for L{twisted.web.templates.XMLFile}'s deprecated filename support.
    """
...
class FlattenIntegrationTests(FlattenTestCase):
    ...
    def test_errorToplevelAttr(self) -> None:
        """
        A templates with a toplevel C{attr} tag will not load; it will raise
    ...
    def test_errorUnnamedAttr(self) -> None:
        """
        A templates with an C{attr} tag with no C{name} attribute will not load;
