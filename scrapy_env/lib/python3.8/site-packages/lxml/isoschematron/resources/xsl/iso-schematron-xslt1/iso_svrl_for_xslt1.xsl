...
<!-- 
  ...
  a named templates such as "process-assert" in this XSLT stylesheet overrides and
  replaces any templates with the same name in the imported skeleton XSLT file.)
  ...
  History:  
   ...
   2008-08-07
    ...
    2007-02-01
       	...
       	* DP. Refactor handling of rich and linkable parameters to a named templates.
