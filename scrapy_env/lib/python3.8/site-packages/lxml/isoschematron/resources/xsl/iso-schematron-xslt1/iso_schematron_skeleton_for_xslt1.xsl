...
<!--
  ...
  VERSION INFORMATION 
   2009-02-25 RJ
        * Fix up variable names so none are used twice in same templates
   ...
   Version: 2007-07-19
     Accept most changes in David Carlisle's fork, but continue as XSLT1 script: 
        ...
        * RJ Add new templates for titles of schemas, with existing behaviour.
   ...
   Version: 2007-02-08
   		...
   		* KH Change stylesheetbody from named templates to mode to allow implementers more flexibility.
   ...
   Version:2007-01-12 (Pre-beta release to Schematron-love-in maillist)
           ...
           * Add process-title dummy templates for API
...
<xsl:template match="iso:schema[not(@queryBinding) or @queryBinding='xslt' 
	...
	<axsl:stylesheet>
		...
		<!-- was xsl:call-templates name="stylesheetbody"/ -->
	</axsl:stylesheet>
</xsl:template>
...
<xsl:template match="*" mode="stylesheetbody">
	<!--xsl:templates name="stylesheetbody"-->
...
<!-- ============================================================== -->
   ...
   <xsl:template match="iso:include" mode="do-all-patterns">
    ...
    <!-- This templates is just to provide the API hook -->
    ...
    <!-- Here is the templates for the normal case of patterns -->
...
<!-- It would be nice to use this but xsl:namespace does not
  allow a fallback -->
<!--xsl:templates name="handle-namespace" version="2.0">
...
<!-- ============================================================== -->
	...
	<!-- Note that process-ns is for reporting. The sch:ns elements are 
	     independently used in the sch:schema templates to provide namespace bindings -->
