...
class IRenderable(Interface):
    ...
    L{twisted.web.templates} templating system.
    """
...
class ITemplateLoader(Interface):
    ...
    L{twisted.web.templates.Element}'s C{loader} attribute.
    """

    def load() -> List["Flattenable"]:
        """
        Load a templates suitable for rendering.

        @return: a L{list} of flattenable objects, such as byte and unicode
            strings, L{twisted.web.templates.Element}s and L{IRenderable} providers.
        """
