...
"""
twisted.web.util and twisted.web.templates merged to avoid cyclic deps
"""
...
def _PRE(text):
    ...
    migrate the html.PRE from current code to twisted.web.templates.

    For new code consider using twisted.web.templates.
...
class _ToStan(handler.ContentHandler, handler.EntityResolver):
    ...
    def startPrefixMapping(self, prefix: Optional[str], uri: str) -> None:
        ...
        # Ignore the templates namespace; we'll replace those during parsing.
    ...
    def startElementNS(
        ...
        # specified as having a namespace in the templates) or prefix:name,
        ...
        # Add the prefix that was used in the parsed templates for non-templates
...
# t.w.templates and it is officially deprecated.
...
class _TagFactory:
    ...
    This allows for the syntactic convenience of C{from twisted.web.templates
