...
def renderer() -> None:
    """
    Decorate with L{renderer} to use methods as templates render directives.
...
class Element:
    ...
    hook its templates (from the loader) up to render methods.
    ...
    def render(self, request: Optional[IRequest]) -> "Flattenable":
        ...
        another's templates or rendering output.

        (This will simply load the templates from the C{loader}; when used in a
        templates, the flattening engine will keep track of this object
