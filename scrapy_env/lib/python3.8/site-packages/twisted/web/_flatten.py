...
def writeWithAttributeEscaping(
    ...
    If a L{Tag <twisted.web.templates.Tag>} C{x} is flattened within the context
    of the contents of another L{Tag <twisted.web.templates.Tag>} C{y}, the
    ...
    However, when a L{Tag <twisted.web.templates.Tag>} C{x} is flattened within
    the context of an I{attribute} of another L{Tag <twisted.web.templates.Tag>}
    ...
    around in a L{twisted.web.templates} templates, it is a condition which may
    ...
    <twisted.web.templates.Comment>} in an attribute you should get C{<y
    ...
    serializing L{Tag <twisted.web.templates.Tag>} and arbitrary L{IRenderable}
...
def _flattenElement(
    ...
    @param root: An object to be made flatter.  This may be of type C{unicode},
        L{str}, L{slot}, L{Tag <twisted.web.templates.Tag>}, L{tuple}, L{list},
...
async def _flattenTree(
    ...
    @param root: An object to be made flatter.  This may be of type C{unicode},
        L{bytes}, L{slot}, L{Tag <twisted.web.templates.Tag>}, L{tuple},
